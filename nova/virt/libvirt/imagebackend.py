...
class Image(object):
    ...
    def __init__(self, path, source_type, driver_format, instance, is_block_dev=False):
...
class Flat(Image):
    ...
    def __init__(self, instance=None, disk_name=None, path=None):
        ...
        path = (path or os.path.join(libvirt_utils.get_instance_path(instance),
                                     disk_name))
        super(Flat, self).__init__(path, "file", "raw", instance, is_block_dev=False)
...
class Qcow2(Image):
    def __init__(self, instance=None, disk_name=None, path=None):
        path = (path or os.path.join(libvirt_utils.get_instance_path(instance),
                                     disk_name))
        super(Qcow2, self).__init__(path, "file", "qcow2", instance, is_block_dev=False)
...
class Lvm(Image):
    ...
    def __init__(self, instance=None, disk_name=None, path=None):
        ...
        super(Lvm, self).__init__(path, "block", "raw", instance, is_block_dev=True)
...
class Rbd(Image):
    ...
    def __init__(self, instance=None, disk_name=None, path=None, **kwargs):
        ...
        super(Rbd, self).__init__(path, "block", "rbd", instance, is_block_dev=False)
